<header class="relative bg-white shadow dark:bg-gray-800">
    <div class="container flex-shrink-0 px-6 py-3 mx-auto md:flex items-center justify-between">
        ...
        @if (Auth::check())
            <a href="/app"
                class=" md:inline-flex hidden items-center justify-center whitespace-nowrap rounded-md text-sm sm:text-base font-medium cursor-pointer transition-colors focus:outline-none disabled:pointer-events-none disabled:opacity-50 focus:ring h-10 px-4 py-2 text-gray-600 hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-800 dark:hover:text-gray-50 focus:ring-gray-100 dark:focus:ring-gray-800">
                Dashboard
            </a>
        @endif
    </div>
