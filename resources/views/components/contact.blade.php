<section class=" dark:bg-gray-900">
    <div class="container px-6 py-12 mx-auto">
        ...
        <img class="object-cover w-full h-64 mt-10 rounded-lg lg:h-96" src="assets/contact-pic.png" alt="">
        ...
        <div class="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-3 sm:grid-cols-2 ">
            ...
            <div class="p-4 rounded-lg bg-blue-50 md:p-6 dark:bg-gray-800">
                ...
                <p class="mt-2 text-sm text-blue-500 dark:text-blue-400">BP 64, Route de Dely Brahim, Chéraga, Alger 16014</p>
            </div>
            ...
            <div class="p-4 rounded-lg bg-blue-50 md:p-6 dark:bg-gray-800">
                ...
                <p class="mt-2 text-sm text-blue-500 dark:text-blue-400">+213 23 14 14 47</p>
            </div>
        </div>
    </div>
</section>
