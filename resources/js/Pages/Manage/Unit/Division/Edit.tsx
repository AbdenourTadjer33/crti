        ...
        <AuthLayout>
            ...
            <div className="space-y-4">
                ...
                <div>
                    ...
                    Utilisez ce formulaire pour modifier les détails
                    de la division <span className=" font-medium">{division.name}</span> au sein de l'unité <span className="font-medium">{unit.name}</span>.
