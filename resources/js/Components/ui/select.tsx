...
>(({ className, children, ...props }, ref) => (
    <SelectPrimitive.Trigger
        ref={ref}
        className={cn(
            "flex h-10 w-full items-center justify-between rounded-md border border-gray-200 bg-white px-3 py-2 pr-0 text-sm placeholder:text-gray-500 focus:outline-none focus:ring focus:ring-primary-600  disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1 dark:border-gray-600 dark:bg-gray-700 dark:placeholder:text-gray-400 dark:focus:ring-primary-500 dark:focus:border-primary-500",
            className
        )}
        {...props}
    >
